export function loadLayout() {
    ...
    if (body.classList.contains('admin-page')) {
        return; // Dừng lại, không load layout cho trang admin.
    }
    ...
    <div class="top-bar">
        <div class="container top-bar-content">
            ...
            <div class="top-bar-right">
                ...
                <a href="/track-order.html">Tra cứu đơn hàng</a>
            </div>
        </div>
    </div>
    <header class="main-header">
        <div class="container header-content">
            <a href="/index.html" class="logo">
                <img src="/images/logo.png" alt="SportStore Logo" style="height: 120px;">
            </a>
            <nav class="main-nav">
                <ul class="nav-list">
            ...
            <div class="header-actions">
                <form id="search-form" class="header-search">
                    <input type="search" id="search-input" placeholder="Tìm kiếm sản phẩm..." autocomplete="off">
    ...
    const footerHTML = `
        <div class="container">
            <div class="footer-grid">
                <div class="footer-section brand-info">
                    ...
                    <div class="social-links">
                        ...
                        <a href="https://www.youtube.com/@fbshopvn" target="_blank" rel="noopener noreferrer" aria-label="YouTube"><i class="fab fa-youtube"></i></a>
                    </div>
                </div>
            ...
            <div class="footer-bottom">
                <p>© ${new Date().getFullYear()} KhảiHoàng. All Rights Reserved.</p>
                <div class="footer-certs">
                    <a href="#" target="_blank" rel="noopener noreferrer">
                        <img src="/images/logo-congthuong/logo2.png" alt="Đã thông báo Bộ Công Thương">
                    </a>
                </div>
            </div>
        </div>
